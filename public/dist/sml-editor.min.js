...
(function (global, factory) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			this.c = noop;
    			add_location(textarea, file, 88, 0, 2088);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(textarea, "keyup", /*keyup*/ ctx[2], false, false, false),
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [value, editor, keyup, textarea_binding, textarea_input_handler];
    }
