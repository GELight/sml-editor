...
(function (global, factory) {
    ...
    class App extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>:host{display:flex;justify-content:stretch;align-items:stretch}textarea{box-sizing:border-box;white-space:pre-wrap;outline:none;tab-size:var(--sml-editor-tab-size);-moz-tab-size:var(--sml-editor-tab-size);-o-tab-size:var(--sml-editor-tab-size);width:100%;max-height:var(--sml-editor-max-height);height:var(--sml-editor-height);overflow:auto;color:var(--sml-editor-color);background:var(--sml-editor-bg);border:var(--sml-editor-border);padding:var(--sml-editor-padding);box-shadow:var(--sml-editor-box-shadow);text-shadow:var(--sml-editor-text-shadow);font-family:var(--sml-editor-font-family);font-size:var(--sml-editor-font-size);line-height:var(--sml-editor-line-height);font-weight:var(--sml-editor-font-weight);font-style:var(--sml-editor-font-style);font-stretch:var(--sml-editor-font-stretch);letter-spacing:var(--sml-editor-letter-spacing);text-transform:var(--sml-editor-text-transform)}</style>`;
